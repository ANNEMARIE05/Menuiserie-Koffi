  ...
  return (
    <Link to={`/produit/${product.id}`} className="block h-full">
      <div className="card overflow-hidden group h-full flex flex-col">
        <div className="relative h-44 sm:h-48 md:h-56 lg:h-64 overflow-hidden bg-gray-100 flex-shrink-0">
          <img
        ...
        <div className="p-3 sm:p-4 md:p-6 flex flex-col flex-grow">
          ...
          <p className="text-xs sm:text-sm text-gray-600 line-clamp-2 mb-2 sm:mb-3 md:mb-4 flex-grow">
            {product.description}
          </p>

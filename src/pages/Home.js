...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section className="relative h-[350px] sm:h-[450px] md:h-[600px] lg:h-[700px] overflow-hidden">
        <Carousel images={imagesHero} autoPlay={true} interval={6000} />        
        <div className="absolute inset-0 bg-gradient-to-r from-marron-900/70 to-transparent flex items-center justify-center">
          <div className="container mx-auto px-4 z-10">
            <div className="max-w-2xl mx-auto text-center md:text-left">        
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-display font-bold text-white mb-2 sm:mb-3 md:mb-4">
                Menuiserie Koffi
              </h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-white/90 mb-3 sm:mb-4 md:mb-6 lg:mb-8 font-light"> 
                Artisanat d'exception, meubles sur mesure
              </p>
              <p className="text-xs sm:text-sm md:text-base lg:text-lg text-white/80 mb-4 sm:mb-6 md:mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4 justify-center md:justify-start">
                <Link to="/produits" className="btn-primary inline-block text-center text-xs sm:text-sm md:text-base">
                  <i className="fas fa-tools mr-2"></i>
                  Découvrir nos créations
                </Link>
                <Link to="/devis" className="btn-secondary inline-block text-center bg-green-600 hover:bg-green-700 text-xs sm:text-sm md:text-base">
      ...
      <section className="py-8 sm:py-10 md:py-12 lg:py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-marron-800 mb-2 sm:mb-3 md:mb-4">
              Notre Savoir-faire
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-4 sm:p-6">
              <div className="bg-kaki-100 w-16 h-16 sm:w-20 sm:h-20 rounded-sm flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-card">
                <i className="fas fa-hammer text-2xl sm:text-3xl text-kaki-700"></i>        
              </div>
              <h3 className="text-lg sm:text-xl font-display font-semibold text-marron-800 mb-2">
                Fait Main
              </h3>
            ...
            <div className="text-center p-4 sm:p-6">
              <div className="bg-kaki-100 w-16 h-16 sm:w-20 sm:h-20 rounded-sm flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-card">
                <i className="fas fa-tree text-2xl sm:text-3xl text-kaki-700"></i>
              </div>
              <h3 className="text-lg sm:text-xl font-display font-semibold text-marron-800 mb-2">
                Bois de Qualité
              </h3>
            ...
            <div className="text-center p-4 sm:p-6">
              <div className="bg-kaki-100 w-16 h-16 sm:w-20 sm:h-20 rounded-sm flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-card">
                <i className="fas fa-ruler-combined text-2xl sm:text-3xl text-kaki-700"></i>
              </div>
              <h3 className="text-lg sm:text-xl font-display font-semibold text-marron-800 mb-2">
                Sur Mesure
              </h3>
      ...
      <section className="py-8 sm:py-10 md:py-12 lg:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center">
            <Link to="/produits" className="btn-primary inline-block text-xs sm:text-sm md:text-base">
      ...
      {/* Section CTA */}
      <section className="py-8 sm:py-10 md:py-12 lg:py-16 bg-marron-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link to="/devis" className="btn-secondary inline-block bg-green-600 hover:bg-green-700 text-xs sm:text-sm md:text-base">
            <i className="fas fa-file-invoice mr-2"></i>
            Demander un devis
          </Link>
        </div>
